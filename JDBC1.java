...
public class JDBC1 {
	public static void main(String args[]) {
		try {
			...
			Connection connection = DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/kholapurdb", userName, password);
			//write queries , stmts
		...
		/*	//dml --> return a int val 
			...
			ResultSet resultSet = stmt.executeQuery("SELECT * FROM addressofowner");
